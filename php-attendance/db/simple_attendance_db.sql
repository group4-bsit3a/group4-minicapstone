...
--
--table structure for table ' students_qrcode'
--

INSERT INTO `students_qrcode` (`id`, `name`, `timein`, `timeout`, `logdate`, `status`);



CREATE TABLE `students_qrcode` (
  `id` int AUTO_INCREMENT PRIMARY KEY,
  
  `name` VARCHAR(255) NOT NULL,
  `timein` datetime NOT NULL DEFAULT current_timestamp(),
  `timeout` datetime DEFAULT NULL ON UPDATE current_timestamp()
  `logdate` datetime DEFAULT NULL ON UPDATE current_date()
